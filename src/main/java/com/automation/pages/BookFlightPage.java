...
public class BookFlightPage {
	...
	public BookFlightPage(WebDriver driver) {
		this.driver = driver;
		//PageFactory.initElements(this.driver, BookFlightPage.class);
	}
	...
	public void purchasePress(String fname, String lname, String meal2, String cType, String cNumber, String eMonth,
			String eYear, String cFirstName, String cMiddleName, String cLastName) {
		try {
			Thread.sleep(2000);
