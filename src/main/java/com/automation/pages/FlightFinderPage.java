...
public class FlightFinderPage {
	...
	public void continueWordPress(String pCount, String fPort, String fMonth, String fDay, String tPort, String tMonth,
			String tDate, String serClass, String aline) {
		try {
			Thread.sleep(2000);
			roundTrip.click();
			Thread.sleep(2000);
